...
module.exports = {
   ...
   */
  include: ['./contracts/smart-locker/assembly/__tests__/**/*.spec.ts'],
  /**
   * A set of globs passed to the glob package that quality files to be added to each test.
   */
  add: ['./contracts/smart-locker/assembly/__tests__/**/*.include.ts'],
  /**
  ...
  coverage: [
    './contracts/smart-locker/assembly/*.ts',
    './contracts/smart-locker/assembly/smart-locker/**/*.ts',
  ],
  /**
